...
export const EditUser = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [userRes, companyRes, roleRes] = await Promise.all([
          ApiService.callFetchUserById(userId),
  ...
  const handleSubmit = async (e) => {
    ...
    if (Object.keys(validationErrors).length === 0) {
      ...
      try {
        const res = await ApiService.callUpdateUser(formData);
        console.log(res);
                ...
                <input
                  ...
                  className={`${
                    errors.email
                      ...
                      : ""
                  } opacity-60  text-gray-900 dark:text-white bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400  dark:focus:ring-primary-500 dark:focus:border-primary-500`}
