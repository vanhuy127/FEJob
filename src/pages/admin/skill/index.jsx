...
export const Skills = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await ApiService.callFetchAllSkill(
  ...
  const deleteSkill = async (skillId) => {
    try {
      const res = await ApiService.callDeleteSkill(skillId);
      if (res.data.statusCode === 200) {
      ...
      {isLoading ? (
        ...
        <>
          <div className="flex items-center justify-between mb-5">
            <h1 className="text-xl font-semibold">Danh sách kỹ năng</h1>
            <Link
                  ...
                  {skills.map((skill, index) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        {skill.createdBy ? skill.createdBy : "-"}
                      </td>
                      <td className="px-6 py-4">
                      ...
                      <td className="px-6 py-4">
                        {skill.createdAt
                          ? convertDateTime(skill.createdAt)
                          : "-"}
                      </td>
                      <td className="px-6 py-4">
                        {skill.updatedAt
                          ? convertDateTime(skill.updatedAt)
                          : "-"}
                      </td>
